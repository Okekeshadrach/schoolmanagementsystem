    ...
    <nav class="navbar top-navbar navbar-expand-md">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#">
                ...
                <b>
                    <!-- Dark Logo icon -->
                    <img src="../assets/img/<?php echo $class->get_school_logo() ?>" alt="school-page" class="dark-logo logo" height="60" width="60" />
                    <!-- Light Logo icon -->
                    <img src="../assets/img/<?php echo $class->get_school_logo() ?>" alt="homepage" class="light-logo logo" height="60" width="60" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span class="short_name" style="color: #fff"><?php echo $class->get_school_short() ?></span>
            </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto mt-md-0">
                ...
                <li class="nav-item hidden-xs-down"><a class="nav-link text-white" id="current_session_name" href="javascript:void(0)"><?php echo $class->global_schoolyear_select() ?></a> </li>
            </ul>
            <!-- ============================================================== -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right scale-up">
                        <ul class="dropdown-user">
                            ...
                            <li role="separator" class="divider"></li>
                            <li>
                                <a class="waves-effect waves-dark" href="../login/logout.php"><i class="fa fa-power-off"></i> Logout</a>
                            </li>
                        </ul>
                    </div>
                </li>
