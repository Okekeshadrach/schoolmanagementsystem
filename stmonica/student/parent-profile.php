                                ...
                                <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-bottom: 1em">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated flipInY"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="student/parent-profile/493c77a4210f5cfc1">Edit
                                                        Profile</a>
                                                    <a class="dropdown-item"
                                                        href="student/capture-parent-passport/493c77a4210f5cfc1">Capture
                                                        Passport</a>
                                                    <a class="dropdown-item"
                                                        href="student/parent-activity/493c77a4210f5cfc1">Activity
                                                        Log</a>

                                                    <a class="dropdown-item"
                                                        href="student/change-parent-password/493c77a4210f5cfc1">Reset
                                                        Password</a>
                                                </div>
                                            </li>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="student/parent-account-status/493c77a4210f5cfc1">Account
                                                    Status</a>
                                            </li>

                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="student/parent-ward/493c77a4210f5cfc1">Ward(s)</a>
                                            </li>

                                        </ul>
                                    </div>
                                </nav>
                                <form action="student/parent-profile-process/8b59528c12ed57d5a2" class="form-horizontal"
                                    id="parent-profile" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="row record" data-id="33cdcfa8121a8b884e">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="house_address"
                                                name="house_address" value="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="email" class="control-label col-form-label">Email
                                                Address</label>
                                            <input type="text" class="form-control to-validate" id="email" name="email"
                                                value="">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="next_kin_phone" class="control-label col-form-label">Next of Kin
                                                (Phone)</label>
                                            <input type="text" class="form-control" id="next_kin_phone"
                                                name="next_kin_phone" value="">
                                        </div>
            ...
            <script>
                $(function () {
                    ...
                    $('.to-validate').change(function () {
                        ...
                        $.post(url, { field: field, value: val, user_type: "parent", id: id }, function (result) {
