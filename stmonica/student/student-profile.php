            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5" id="student-profile-div">
                        <div class="card" id="student-profile-side">
                            ...
                            <div class="card-body">
                                ...
                                <h6 id="s-email">
                                    <a class="text-info" href="student/parent-profile/798c6f9228616bda6d9d" target="_blank">
                                        Mr Amobi </a>
                                </h6>
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated flipInY" aria-labelledby="navbarDropdownMenuLink">
                                                    <a class="dropdown-item" href="student/student-profile/2d9c209f2858b1f67857">Edit
                                                        Profile</a>
                                                    <a class="dropdown-item" href="student/capture-passport/2d9c209f2858b1f67857">Capture
                                                        Passport</a>
                                                    <a class="dropdown-item" href="student/activity/2d9c209f2858b1f67857">Activity
                                                        Log</a>

                                                    <a class="dropdown-item" href="student/change-password/2d9c209f2858b1f67857">Reset
                                                        Password</a>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link " href="student/account-status/2d9c209f2858b1f67857">Account
                                                    Status</a>
                                            </li>

                                            <li class="nav-item">
                                                <a class="nav-link " href="student/class-trail/2d9c209f2858b1f67857">Class
                                                    Trail</a>
                                            </li>
                ...
                <a class="nav-link" href="#">Performance Analytics</a>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated flipInY" aria-labelledby="navbarDropdownMenuLink">
                                                    <a class="dropdown-item" href="student/current-bill/2d9c209f2858b1f67857">Current
                                                        Bill Invoice</a>
                                                    <a class="dropdown-item" href="payment/transaction-log/2d9c209f2858b1f67857">Transaction
                                                        Log</a>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated flipInY" aria-labelledby="navbarDropdownMenuLink">
                                                    <a class="dropdown-item" href="student/withdrawn-students" title="Is Ifechukwu back to school? Click here to return her to the system." data-toggle="tooltip">Return to Class</a>

                                                    <a class="dropdown-item" href="student/registration-printout/2d9c209f2858b1f67857" target="_blank">Registration Printout</a>
                                ...
                                <form action="student/student-profile-process/6eb80ba95906b4549f47" class="form-horizontal" id="student-profile" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="row record" data-id="df7cea02590681d281e1">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="surname" name="surname" value="Amobi" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="first_name" class="control-label col-form-label">First Name
                                                <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="first_name" name="first_name" value="Ifechukwu" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control date" placeholder="YYYY-MM-DD" id="dob" name="dob" value="2017-12-20" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label col-form-label">Gender <span class="text-danger">*</span></label><br>
                                            <input name="gender" type="radio" id="radio_2" class="with-gap radio-col-deep-purple" value="F" checked />
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="admno" class="control-label col-form-label">Admission Number
                                                <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control to-validate" id="admno" name="admno" value="">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="custom-select form-control" id="lga" name="lga_id" style="width: 100%" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="res" class="control-label col-form-label">Residence Type <span class="text-danger">*</span></label>
                                            <select class="custom-select form-control select2" id="res" name="residence_type" style="width: 100%">
                                                <option value=""></option>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" value="75322" maxlength="11">
                                        </div>
                                        <div class="form-group col-md-6">
