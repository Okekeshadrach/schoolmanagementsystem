                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="classes/nominal-roll.html" target="_blank" method="post"
                                    ...
                                    <div class="row">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="name_width" type="number" min=5 max=40
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>2</td>
                                                            ...
                                                            <td>
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="adm_no" type="checkbox"
                                                                            class="form-control" value="admno"
                                                                            checked />
                                                                        <span
                                                                            class="lever switch-col-light-blue"></span>
                                                                    </label>
                                                            ...
                                                            <td><input name="adm_no_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>3</td>
                                                            ...
                                                            <td><input name="username_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>4</td>
                                                            ...
                                                            <td><input name="gender_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>5</td>
                                                            ...
                                                            <td><input name="house_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>6</td>
                                                            ...
                                                            <td>
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="residence" type="checkbox"
                                                                            class="form-control" value="residence_type"
                                                                            checked />
                                                                        <span
                                                                            class="lever switch-col-light-blue"></span>
                                                                    </label>
                                                            ...
                                                            <td><input name="residence_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>7</td>
                                                                ...
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="dob" type="checkbox"
                                                                            class="form-control" value="dob" checked />
                                                                        <span
                                                                            class="lever switch-col-light-blue"></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td><input name="dob_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>8</td>
                                                            ...
                                                            <td><input name="class_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>9</td>
                                                            ...
                                                            <td><input name="email_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>10</td>
                                                            ...
                                                            <td><input name="phone_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>11</td>
                                                            ...
                                                            <td><input name="state_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>12</td>
                                                            ...
                                                            <td>
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="lga" type="checkbox"
                                                                            class="form-control" value="lga" />
                                                                        <span
                                                                            class="lever switch-col-light-blue"></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td><input name="lga_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>13</td>
                                                            ...
                                                            <td>
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="religion" type="checkbox"
                                                            ...
                                                            <td><input name="religion_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>14</td>
                                                            ...
                                                            <td>
                                                                <div class="switch">
                                                                    <label>
                                                                        <input name="genotype" type="checkbox"
                                                                            class="form-control" value="genotype" />
                                                                        <span
                                                                            class="lever switch-col-light-blue"></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td><input name="genotype_width" type="number" min=5 max=30
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>15</td>
                                                            ...
                                                            <td><input name="address_width" type="number" min=5 max=40
                                                                    class="form-control" placeholder="Default" /></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="page_title" id="page_title" type="text"
                                                    class="form-control" value="CLASS NOMINAL ROLL" />
                                            </div>
                                            <div class="form-group">
                                                <label class="text-right control-label col-form-label">Preferred
                                                    Document Format:</label>
                                                <div class="col-sm-9">
                                                    <input name="doc_type" type="radio" id="radio_1"
                                                        class="with-gap radio-col-deep-purple" value="pdf" checked />
                                                    <label class="form-control-label m-r-20" for="radio_1">PDF</label>

                                                    <input name="doc_type" type="radio" id="radio_2"
                                                        class="with-gap radio-col-deep-purple" value="csv" />
                                            ...
                                            <div style="display: none" id="div_more_options">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-9">
                                                        <input name="settings_residence" type="radio" id="s_r_1"
                                                            class="with-gap radio-col-deep-purple" value="1" />
                                                        <label class="form-control-label m-r-20" for="s_r_1">Day
                                                            students only</label>

                                                        <input name="settings_residence" type="radio" id="s_r_2"
                                                            class="with-gap radio-col-deep-purple" value="2" />
                                                        <label class="form-control-label" for="s_r_2">Boarding students
                                                            only</label>

                                                        <input name="settings_residence" type="radio" id="s_r_3"
                                                            class="with-gap radio-col-deep-purple" value="" checked />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input name="addcol[]" type="text" class="form-control"
                                                    ...
                                                    <div class="form-group clearfix">
                                                        <button type="button"
                                                            class="btn btn-success btn-circle btn-sm pull-right"
                                                            id="add-col"><span class="fa fa-plus"></span></button>
                                                    </div>
                                                </div>
                                                <hr>
                                            </div>

                                            <input class="btn btn-primary btn-rounded m-t-10" type="submit"
                                                value="Proceed" name="submit_nominal_roll" />
                                        </div>
                                    </div>
                                </form>
                            </div>
