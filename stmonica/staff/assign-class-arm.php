                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5" id="staff-profile-div">
                        <div class="card" id="staff-profile-side">
                            ...
                            <div class="card-body">
                                ...
                                <h6>
                                    <a href="classes/manage-students/843000cb13e763bed2/9ac1915110b2308c28"
                                        class="text-info">JSS 2A</a>, <a
                                        href="classes/manage-students/91de401613a6762851/f3ef8c7011edef75a8"
                                        class="text-info">JSS 2B</a>, <a
                                        href="classes/manage-students/2c0c34da133421788e/bf5e52d3123fd0d9ac"
                                        class="text-info">JSS 2C</a>, <a
                                        href="classes/manage-students/56607c8a133c1b6820/b682f3f0133f6a7be8"
                                        class="text-info">JSS 2D</a>, <a
                                        href="classes/manage-students/b7fbde0f13b1e29b06/fea4ef2914654d13c6"
                                        class="text-info">JSS 2E</a>, <a
                                        href="classes/manage-students/acaf9939139c3e430b/737bb9b9158280ab7e"
                                        class="text-info">JSS 2G</a>, <a
                                        href="classes/manage-students/e08feed8137da9d2f6/1d26f4af16f38950ad"
                                        class="text-info">JSS 2H</a>, <a
                                        href="classes/manage-students/461f7e3213b831b6a7/14b948f017cd7c8fd4"
                                        class="text-info">JSS 2J</a>, <a
                                        href="classes/manage-students/e4328f60139833ce55/de871865183ad1b6db"
                                        class="text-info">JSS 2K</a>, <a
                                        href="classes/manage-students/9c9a5814136c5b34f8/5109133f1e033e43a"
                                        class="text-info">JSS 1A</a>, <a
                                        href="classes/manage-students/f77a7b3713c2ce2806/ae459e5d2b0aff3ca"
                                        class="text-info">JSS 1B</a>, <a
                                        href="classes/manage-students/5a900d6013ac894bcb/6c3b1e21328740a5d"
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>You want to make Mr Obinozie Nnamdi Francis a class teacher of a class arm?</p>

                                <form action="staff/assign-class-arm-process/5047f2e72c815caa6" class="form-horizontal"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="custom-select form-control select2" id="class_arm_id"
                                                ...
                                                <option value=""></option>
                                                <option value="2b2f0eb51aaa3839a">JSS 1A</option>
                                                <option value="bca8d843296292fe2">JSS 1B</option>
                                                <option value="f09544833f82c319c">JSS 1C</option>
                                                <option value="94d7cd7d4ab45cb42">JSS 1D</option>
                                                <option value="da897c68580b684a6">JSS 1E</option>
                                                <option value="29c29ad1621d7a7fd">JSS 1G</option>
                                                <option value="095a58e276c98d8dc">JSS 1H</option>
                                                <option value="f874119b88a3f160a">JSS 1J</option>
                                                <option value="126889499525b3678">JSS 1K</option>
                                                <option value="8419e8ab10704ec1d2">JSS 2A</option>
                                                <option value="571e3f1911d9f3bb6e">JSS 2B</option>
                                                <option value="c7692e01128a9248ed">JSS 2C</option>
                                                <option value="97bebc0f138fb3df5d">JSS 2D</option>
                                                <option value="1a60a29f1401564206">JSS 2E</option>
                                                <option value="f6f73f6e15c80eee8f">JSS 2G</option>
                                                <option value="0cfb7ce916ff9d0825">JSS 2H</option>
                                                <option value="2ed73ede174806d5e1">JSS 2J</option>
                                                <option value="dc13157d183cbbc1a9">JSS 2K</option>
                                                <option value="bad26a4046def53df9">JSS 3A</option>
                                                <option value="3b639d51471411904e">JSS 3B</option>
                                                <option value="11815b7f4838f9700f">JSS 3C</option>
                                                <option value="bdfd0719496cb88852">JSS 3D</option>
                                                <option value="a0db76b650b49376a6">JSS 3E</option>
                                                <option value="f89ac1fc5176520975">JSS 3G</option>
                                                <option value="f6f15aad52b3ce1330">JSS 3H</option>
                                                <option value="87450c4853d30e82ab">JSS 3J</option>
                                                <option value="1c2d43bc540b03cf6e">JSS 3K</option>
                                                <option value="c26cb7c719c3f3de67">SS 1A</option>
                                                <option value="0bba551b201858448c">SS 1B</option>
                                                <option value="12c4af4f55e945cf8f">SS 1BECE</option>
                                                <option value="293e60f121709eeb1e">SS 1C</option>
                                                <option value="1c459eac2206eea149">SS 1D</option>
                                                <option value="e840cf7d23435ee13f">SS 1E</option>
                                                <option value="6ac2f973247e4ea1c3">SS 1G</option>
                                                <option value="7b7a10f025564029be">SS 1H</option>
                                                <option value="16b4b35d2603535826">SS 1J</option>
                                                <option value="c250ab4b276a338e0d">SS 1K</option>
                                                <option value="d3ea85342837a5fc1a">SS 2A</option>
                                                <option value="2adf18d4296b57f56b">SS 2B</option>
                                                <option value="f03bc0c230169aef7a">SS 2C</option>
                                                <option value="141de1ec313832d16d">SS 2D</option>
                                                <option value="f0071f5a3238d0c05b">SS 2E</option>
                                                <option value="d64ec1e233625b4023">SS 2G</option>
                                                <option value="2395444e344ff5a22d">SS 2H</option>
                                                <option value="d75ce33835dec53646">SS 2J</option>
                                                <option value="b5d50aba36215e8f02">SS 2K</option>
                                                <option value="dc7d8b8d376e87acda">SS 3A</option>
                                                <option value="b6a143923834b15a4b">SS 3B</option>
                                                <option value="84e0ea9b397c2a657b">SS 3C</option>
                                                <option value="49ccb86640b71faf91">SS 3D</option>
                                                <option value="09b67c714192a6d05e">SS 3E</option>
                                                <option value="5ba4d2c042d8dca8c4">SS 3G</option>
                                                <option value="642b0eb043afb3d323">SS 3H</option>
                                                <option value="6bce4e9444f074f290">SS 3J</option>
                                                <option value="a772250445531d1cec">SS 3K</option>
                                            </select>
                                        </div>
                                    </div>
