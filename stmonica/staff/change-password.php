                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card" id="staff-profile-side">
                            ...
                            <div class="card-body">
                                ...
                                <h6>
                                    <a href="classes/manage-students/571e0f7e1345b27b7f/3f9427671041391acb"
                                        class="text-info">JSS 2A</a>, <a
                                        href="classes/manage-students/98437e6413f2772b7a/6d80287f112ba2a742"
                                        class="text-info">JSS 2B</a>, <a
                                        href="classes/manage-students/9a190bc813e8887f7a/ea47748512ef2d594b"
                                        class="text-info">JSS 2C</a>, <a
                                        href="classes/manage-students/3dbfb4b61300a02e8b/896d2ba9138dd143f6"
                                        class="text-info">JSS 2D</a>, <a
                                        href="classes/manage-students/fc7302ae13d372d9fc/1bcadded142288d178"
                                        class="text-info">JSS 2E</a>, <a
                                        href="classes/manage-students/fbbe439713701d043a/1e1692bf151fb19d51"
                                        class="text-info">JSS 2G</a>, <a
                                        href="classes/manage-students/494d98601387321945/666e9f3c16c087ffb6"
                                        class="text-info">JSS 2H</a>, <a
                                        href="classes/manage-students/eaf0404b1381a34aaf/0829515a17a170f8e8"
                                        class="text-info">JSS 2J</a>, <a
                                        href="classes/manage-students/bc5477ed1391032eb8/d617763718fb25250a"
                                        class="text-info">JSS 2K</a>, <a
                                        href="classes/manage-students/649e97f9139521e642/23732d211becfb396"
                                        class="text-info">JSS 1A</a>, <a
                                        href="classes/manage-students/ce89e644130a393c1c/921a145420016b072"
                                        class="text-info">JSS 1B</a>, <a
                                        href="classes/manage-students/86b8fc1d1375248e73/925f6ff431ab9110a"
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="login/reset-password-process/41dd114957d2ff2aa" id="change-password"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="password" class="form-control" name="new_password"
                                                    id="new_password" value="" required autocomplete="off"
                                                    minlength="6">
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="password" class="form-control" name="new_password_repeat"
                                                    id="new_password_repeat" value="" required autocomplete="off"
                                                    minlength="6">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <a href="staff/staff-profile/5047f2e72c815caa6"
                                            class="btn btn-warning btn-rounded waves-effect waves-light m-t-10">Close</a>
                                        <button type="submit"
                                            class="btn btn-primary btn-rounded waves-effect waves-light m-t-10">Submit
                                        </button>
                                    </div>
