...
<link href="https://krystalng.com/fggconitsha/assets/plugins/wizard/steps.css" rel="stylesheet">
<link href="https://krystalng.com/fggconitsha/assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"
      rel="stylesheet">
<!-- =======================  This page styles =================== ---->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="https://krystalng.com/fggconitsha/admin-account/create-process" id="create-admin" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <section>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
