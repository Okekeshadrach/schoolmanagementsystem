...
<head>
    ...
    <style>
        ...
        .custom-textarea {
            min-height: 200px; max-height: 500px; border: 1px solid #ccc; border-radius: 5px; overflow: auto;
        }
    </style>
...
<link href="https://stmonica.com/stmonica/assets/plugins/wizard/steps.css" rel="stylesheet">
<link href="https://stmonica.com/stmonica/assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"
      rel="stylesheet">
<!-- =======================  This page styles =================== ---->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="https://stmonica.com/stmonica/admin-account/create-process" id="create-admin" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <section>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="admin[address]" class="form-control" id="address"
                                               minlength="10">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-12" style="padding-left: 0">
                                            <input name="admin[gender]" type="radio" id="radio_1"
                                                   class="with-gap radio-col-deep-purple" value="M"/>
                                            <label class="form-control-label" for="radio_1">Male</label>

                                            <input name="admin[gender]" type="radio" id="radio_2"
...
<script src="https://stmonica.com/stmonica/assets/plugins/wizard/jquery.steps.min.js"></script>
<script src="https://stmonica.com/stmonica/assets/plugins/moment/moment.js"></script>
<script src="https://stmonica.com/stmonica/assets/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
...
<script>
    $(function () {
        ...
        $('.to-validate').change(function(){
            ...
            var val     = a.val();
            var user_type = 'admin';
            var url     = 'https://stmonica.com/stmonica/user-account/validate-user-field';
            ...
            $.post(url, {field : field, value : val, user_type : user_type}, function (result) {
