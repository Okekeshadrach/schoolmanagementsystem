...
<head>
    ...
    <meta name="description" content="St. Monica Nursery and Primary School, Ibusa">
    <meta name="keywords" content="education, school">
    ...
    <title>BiNoZyDiGiTaL - St. Monica - School Portal</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(assets/img/home_pix_bb844d7f189a9834c.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <h3 href="javascript:void(0)" class="text-center db"><img src="assets/img/logo_4a262eb69667.png" alt="Home" height="150" /><br />BiNoZyDiGiTaL - St. Monica Nursery and Primary </h3>
                <br>
                <p class="text-center db">SCHOOL DATA MANAGEMENT SYSTEM</p>
                ...
                <div id="recoverform" style="display: none">
                    <form action="login/reset-password-request" class="form-horizontal" method="post" accept-charset="utf-8">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" type="email" name="user_email" required placeholder="e.g. you@gmail.com">
                            </div>
                        </div>
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
