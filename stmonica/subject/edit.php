                ...
                <div class="row">
                    <div class="offset-md-3 col-md-6">
                        <div class="card card-body">
                            <form action="../subject/edit-process/2d0f896a4ca184be1" id="subj-edit" method="post" accept-charset="utf-8">
                                ...
                                <div class="modal-footer">
                                    <a href="../subject" class="btn btn-warning btn-rounded waves-effect waves-light m-t-10">Close</a>
