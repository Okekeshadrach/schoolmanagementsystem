    ...
    <div class="row">
        <div class="offset-md-3 col-md-6">
            <div class="card card-body">
                <form action="https://stmonica.com/stmonica/subject/edit-process/2d0f896a4ca184be1" id="subj-edit" method="post" accept-charset="utf-8">
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label for="name">Subject Name</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="e.g. Mathematics" value="A" required>
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="short_name">Subject Short Name</label>
                            <input type="text" name="short_name" value="EFGG" class="form-control" id="short_name" placeholder="e.g. MATHS" maxlength="5" required>
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="dept_id">Subject Department</label>
                            <select class="custom-select form-control select2" id="dept_id" name="dept_id"
                                    style="width: 100%" required>
                                <option value=""></option>
            
                                                                    <option value="280580591668b685a" selected>
                                        BINOZY&rsquo;s DiGiTaL                                    </option>
                ...
                <div class="modal-footer">
                    <a href="https://stmonica.com/stmonica/subject"
