...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0" id="page-title">Edit Department</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="offset-md-3 col-md-6">
                        <div class="card card-body">
                            <form action="../subject/dept-edit-process/f8fe3525187323e1d" id="dept-edit" method="post" accept-charset="utf-8">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label for="dept_name">Name of Department </label>
                                            <input type="text" name="dept_name" class="form-control" id="dept_name" value="Krystal&rsquo;s IT Academy" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <a href="../subject/departments" class="btn btn-warning btn-rounded waves-effect waves-light m-t-10">Close</a>
            ...
            <script>
                $('#dept-edit').submit(function(e) {
                    e.preventDefault();
                    var jqxhr = submit_form('#dept-edit');
