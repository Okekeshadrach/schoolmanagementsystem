                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0" id="page-title">
                            Send Report Card to parents: JSS 1A </h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="score/report-card/d6fd49ad137f5edbe4/170ac27a1b5177272/1"
                                            target="_blank"
                                            class="btn btn-outline-primary btn-rounded waves-effect waves-light m-b-30">
                                            Send 1st Batch
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <a href="score/report-card/d6fd49ad137f5edbe4/170ac27a1b5177272/2"
                                            target="_blank"
                                            class="btn btn-outline-primary btn-rounded waves-effect waves-light m-b-30">
                                            Send 2nd Batch
                                        </a>
                                    ...
                                    <div class="col-md-2">
                                        <a href="score/report-card/d6fd49ad137f5edbe4/170ac27a1b5177272/3"
                                            target="_blank"
                                            class="btn btn-outline-primary btn-rounded waves-effect waves-light m-b-30">
                                            Send 3rd Batch
                                        </a>
                                    ...
                                    <div class="alert alert-primary alert-rounded">Results are broken into groups of
                                        ...
                                        least 1 Subject(s).<button type="button" class="close" data-dismiss="alert"
