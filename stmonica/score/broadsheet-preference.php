            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <small class="pull-right">
                                    <i>
                                        Class Teacher :
                                        <a href="../staff/staff-profile/0e1e77ae2324df911">
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu animated flipInY" aria-labelledby="navbarDropdownMenuLink">
                                                    ...
                                                    <a class="dropdown-item" href="../score/term-analysis/284c360e13261962ea/8f1fee3f1f8e69b0a" title="see performance analysis of students in JSS 1 class corridor" data-toggle="tooltip" target="_blank">Term Analysis</a>
                ...
                <script>
                    $('#myform').submit(function(e) {
                        ...
                        second_term_sess_id_enc = 'd9d9c11e860df126';
                        score_type = $('#score_type').val();
                        class_type = $('input[name=class_type]:checked').val();

                        if (score_type === '_cumulative') {
                            action = site_url + 'score/cumulative-broadsheet/' + second_term_sess_id_enc + '/8f1fee3f1f8e69b0a/' + class_type;
                        } else if (score_type === 'term-weight') {
                            action = site_url + 'score/term-weight-broadsheet/284c360e13261962ea/8f1fee3f1f8e69b0a/' + class_type;
                        } else {
                            action = (score_type === 'cumulative') ? site_url + 'score/cumulative-broadsheet/284c360e13261962ea/8f1fee3f1f8e69b0a/' + class_type : site_url + 'score/broadsheet/284c360e13261962ea/8f1fee3f1f8e69b0a/' + score_type + '/' + class_type;
                        }
