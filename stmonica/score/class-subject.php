                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0" id="page-title">
                            Class Result Computation: JSS 1A </h3>
                        <ol class="breadcrumb">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="subject/assign-teacher"><span
                                                        class="label label-light-danger">Unassigned</span></a>
                                            </td>

                                            <td>
                                                <a class="btn btn-outline-primary btn-rounded btn-sm waves-effect waves-light m-t-10"
                                                    data-toggle="tooltip"
                                                    title="View/Print Skills Development Class (general) Datasheet"
                                                    target="_blank"
                                                    href="score/subject-datasheet-print/d6fd49ad137f5edbe4/170ac27a1b5177272/72e6f5ae1943be758/current-term">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-rounded btn-sm waves-effect waves-light m-t-10"
                                                    data-toggle="tooltip"
                                                    title="Download a csv file. You can enter Enter Scores therein and upload later"
                                                    href="score/csv-download/d6fd49ad137f5edbe4/170ac27a1b5177272/6294268a116e01348">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    <a class="btn btn-success btn-rounded btn-sm waves-effect waves-light m-t-10"
                                                        data-toggle="tooltip"
                                                        title="Enter or update scores for this subject"
                                                        href="score/score-update-form/0f00b7f913ed0e456f/170ac27a1b5177272/174348111e30ffb42">
