            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0" id="page-title">
                            Student Subject Score Ranking - JSS 1A </h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <small class="pull-right">
                                    <i>
                                        Class Teacher :
                                        <a href="staff/staff-profile/2efc8cba283877e38">
                                ...
                                <p class="text-center">Here, you can pull out names of students ranked according to
                                    their performance in a particular subject in this academic session</p>
                                        ...
                                        <div class="offset-md-4 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="subject_id" id="subj"
                                                    ...
                                                    required>
                                                    <option value="cb3d2dd11c96a3c8c">Skills Development Class (general)
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required name="score_type" class="selectpicker"
                                                    data-style="form-control btn-secondary" id="score_type">
                                            ...
                                            <div class="form-group">
                                                <input name="all_arm" type="radio" id="radio_1"
                                                    class="with-gap radio-col-deep-purple" value="2" required checked />
                                                <label class="form-control-label" for="radio_1">Consider JSS 1A
                                                    only</label>

                                                <input name="all_arm" type="radio" id="radio_2"
                                                    class="with-gap radio-col-deep-purple" value="1" required />
                                                <label class="form-control-label" for="radio_2">Consider Entire JSS
                                                    1</label>
                                            </div>
                                            <div class="form-group">
                                                <label for="order_by">Ordering</label>
                                                <select required name="order_by" class="selectpicker"
                                                    data-style="form-control btn-secondary" id="order_by">
                ...
                <script>
                    $('#myform').submit(function (e) {
                        ...
                        previous_sess_id_enc = 'f6059d59cab77d80';
                        subj_id = $('#subj').val();
                        ...
                        if (score_type === '_cumulative') {
                            action = site_url + 'score/student-subject-ranking-cumulative/' + previous_sess_id_enc + '/170ac27a1b5177272/' + subj_id + '/' + all_arm + '/' + order_by + '/' + limit;
                        } else {
                            action = (score_type === 'cumulative') ?
                                site_url + 'score/student-subject-ranking-cumulative/d6fd49ad137f5edbe4/170ac27a1b5177272/' + subj_id + '/' + all_arm + '/' + order_by + '/' + limit :
                                site_url + 'score/student-subject-ranking/d6fd49ad137f5edbe4/170ac27a1b5177272/' + subj_id + '/' + score_type + '/' + all_arm + '/' + order_by + '/' + limit;
                        }
