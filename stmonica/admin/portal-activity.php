                                    ...
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted user-email">obinoziehenry@gmail.com</p><a href="admin/profile.php" class="btn btn-rounded btn-danger btn-sm">View Profile</a>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a class="waves-effect waves-dark" href="staff/manage.php" title="See List of all staff on the system" data-toggle="tooltip">Manage
                                        Staff</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">All Portal Activity</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="admin-account">Dashboard</a></li>
                            <li class="breadcrumb-item active">Portal Activity</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-control-label" for="user_type">Showing activities
                                                by</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="time" class="selectpicker" data-style="form-control btn-secondary" id="time" required>
                                                <option value="today">Today</option>
                                                <option value="1week">In the last 1 week</option>
                                                <option value="1month">In the last 1 month</option>
                                                <option value="2month">In the last 2 months</option>
                                                <option value="6month">In the last 6 months</option>
                                                <option value="1year">In the last 1 year</option>
                                ...
                                <div class="table-responsive-lg" id="resp-div">
                                    <table class="table table-bordered table-striped" style="min-width: 500px;" id="resp-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th></th>
                                        ...
                                        <tbody style="font-size: 14px">
                                            ...
                                            <tr>
                                                <td colspan="6">No activity was found.</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            <script>
                $(function() {
                    ...
                    $('#time, #user_type').change(function() {
                        var user_type = $('#user_type').val();
                        var time = $('#time').val();

                        $('.preloader').show();
                        $('#resp-div').load(site_url + 'admin-account/portal-activity/' + user_type + '/' + time + ' #resp-table', function() {
                            $('.preloader').hide();
