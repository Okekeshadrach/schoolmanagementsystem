                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a class="waves-effect waves-dark" href="admin-account.html.html/manage"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5" id="admin-profile-div">
                        <div class="card" id="admin-profile-side">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="uploads/nobody_m.jpg" alt="user"
                                        class="img-circle profile-pic" id="profile-side-pic" width="150" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="map-box">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.297058939435!2d3.38383275843295!3d6.484013503244671!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8c83af4560bb%3A0xdce4fba04d9f5a03!2s42+Jebba+St%2C+Adekunle%2C+Lagos%2C+Nigeria!5e0!3m2!1sen!2sus!4v1521631626307"
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile" role="tabpanel">
                                    <div class="card-body">
                                        <form action="admin/profile-process/818cf66e328855f7d"
                                            class="form-horizontal form-material" id="profile-update" method="post"
                                            accept-charset="utf-8">
                                            <div class="form-group">
                                                <label class="col-md-12">First Name</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="first_name" placeholder="Enter name"
                                                        value="Henry" class="form-control form-control-line" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Middle Name</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="sec_name" value="Ebuka"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="surname" value="Obinozie"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input name="gender" type="radio" id="radio_1"
                                                        class="with-gap radio-col-deep-purple" checked value="M" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="email" name="email" value="obinoziehenry@gmail.com"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="phone" value="08037370787"
                                                        placeholder="e.g 07011223344"
                                                        class="form-control form-control-line" required minlength="11">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Address</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="address" value="FGGC ONITSHA"
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <button type="submit"
                                                        class="btn btn-primary btn-rounded waves-effect waves-light m-t-10">Update
                                                        Profile</button>
                                ...
                                <div class="tab-pane" id="activity" role="tabpanel">
                                    <div class="card-body table-responsive-lg">
                                        <table
                                            class="table table-striped table-bordered stylish-table color-table success-table"
                                        ...
                                        <a href="admin/my-activity"><button
                                ...
                                <div class="tab-pane" id="settings" role="tabpanel">
                                    <div class="card-body">
                                        <form action="admin_account/capture-passport-process/4eeb76173209dec58"
                                            id="admin-passport" enctype="multipart/form-data" method="post"
                                            accept-charset="utf-8">
                                            <div class="form-group">
