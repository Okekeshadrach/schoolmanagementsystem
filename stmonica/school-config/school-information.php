                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="school-config/school-info-process" id="school-info"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name"
                                                    value="Krystal’s IT Academy F.G.G.C, NKWELLE EZUNAKA" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="short_name" class="form-control"
                                                    id="short_name" value="F.G.G.C NKWELLE" required maxlength="15">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="princ_title">Principal's
                                                    Designation :</label>
                                                <input type="text" name="princ_title" class="form-control"
                                                    id="princ_title" value="Project Manager KITA" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-control-label" for="established">Year of
                                                    Establishment :</label>
                                                <input type="number" name="established" class="form-control"
                                                    id="established" value="1928" required maxlength="4" max="2022">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-control-label" for="gender_type">Gender Type
                                                    :</label>
                                                <select name="gender_type" class="selectpicker"
                                                    data-style="form-control btn-secondary" id="gender_type" required>
                                                    <option>Both</option>
                                                    <option>Male</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email1" class="form-control" id="email1"
                                                    value="info@krystaldigitalng.com" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="site_keyword">Site Keywords
                                                    :</label>
                                                <textarea type="text" name="site_keyword" class="form-control"
                                                    id="site_keyword" required>school, education</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="site_desc">Site Description
                                                    :</label>
                                                <textarea type="text" name="site_desc" class="form-control"
                                                    id="site_desc"
                                                    required>Federal Government Girls College, Nkwelle Ezunaka</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="address1">Address 1 :</label>
                                                <textarea type="text" name="address1" class="form-control" id="address1"
                                                    required>Nkwelle Ezunaka</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="address2">Address 2 :</label>
                                                <textarea type="text" name="address2" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="princ_sign_img">Principal's
                                                    Signature :</label>
                                                <img src="assets/img/princ_sign_d8e59db65c4c.png" height="100"
                                                    class="img-rounded princ_sign">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="princ_sign" class="form-control"
                                                    id="princ_sign">
                                                <small class="text-info">(JPG, JPEG, or PNG. Max Size: 100KB)</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="home_pix_img">Landing Page
                                                    Picture :</label>
                                                <img src="assets/img/home_pix_bb844d7f189a9834c.jpg" height="100"
                                                    class="img-rounded home_pix">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
