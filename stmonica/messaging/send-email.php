            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Send Email</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-body">
                                <form action="messaging/send-email-process" id="send-email" method="post" accept-charset="utf-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label class="form-control-label" for="subject">Email Subject</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="bcc" id="bcc" placeholder="optional">
                                                <small class="text-info">Use a <i class="text-success">comma</i> to
                                                    separate multiple emails</small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <p>If you want to include a custom field e.g The user's Full Name, Username, Phone
                                        Number etc as part of your email, use the pattern below:</p>
                                    <ul>
