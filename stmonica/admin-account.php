    ...
    <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a class="waves-effect waves-dark" href="staff/manage1" title="See List of all administrators on the system" data-toggle="tooltip">Manage Admin</a></li>
                    ...
                    <div class="col-lg-8">
                                    ...
                                    <table class="table stylish-table color-table table-bordered success-table" style="min-width: 400px">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="50%">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger active progress-bar-striped" style="width: 0%; height: 14px" role="progressbar">
                                                            0%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="classes/class-data-completion.php" target="_blank" class="btn btn-success btn-sm btn-rounded waves-effect waves-light">See
                                                        details
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-warning active progress-bar-striped" style="width: 61%; height: 14px" role="progressbar">
                                                            61%
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-success active progress-bar-striped" style="width: 72%; height: 14px" role="progressbar">
                                                            72%
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger active progress-bar-striped" style="width: 39%; height: 14px" role="progressbar">
                                                            39%
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger active progress-bar-striped" style="width: 46%; height: 14px" role="progressbar">
                                                            46%
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger active progress-bar-striped" style="width: 36%; height: 14px" role="progressbar">
                                                            36%
                                                        </div>
                                                    </div>
                                                </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="pull-right">
                                    <a href="javascript: void()" class="btn btn-outline-success btn-sm btn-rounded waves-effect waves-light">See
                                        more...</a>
                                </p>
                            </div>
                        </div>
        ...
        <div class="col-lg-6">
            ...
            <footer class="footer">
                ...
                <a href="https://krystaldigitalng.com" target="_blank">BiNoZy DiGiTaL koncept</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
