                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0" id="page-title">
                            Create Combination Subject for JSS 1A </h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="classes/create-combo-subject-process" id="form_make_combo" method="post"
                                    ...
                                    <div class="row">
                                        <div class="offset-md-3 col-md-6">
                                                ...
                                                <div id="make-combo" style="display: none;">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 m-b-10 select2-multiple"
                                                            name="sub_subj[]" style="width: 100%" multiple="multiple"
                                                            data-placeholder="Choose" id="sub_subj" required>
                                                            <option></option>
                                            ...
                                            <div class="form-group">
                                                <input name="entire_class" type="radio" id="radio_1"
                                                    class="with-gap radio-col-deep-purple" value="2" required />
                                                <label class="form-control-label" for="radio_1">For JSS 1A only</label>

                                                <input name="entire_class" type="radio" id="radio_2"
                                                    class="with-gap radio-col-deep-purple" value="1" required checked />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="class_name" value="JSS 1">
