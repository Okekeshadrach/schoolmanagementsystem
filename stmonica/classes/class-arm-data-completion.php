            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Student Data Completion Rate - JSS 1A</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p>Number of students in class : <b>46 students</b></p>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="classes/manage-student.html"
                                            class="btn btn-primary btn-rounded waves-effect waves-light m-t-10 m-b-20">Go
