            ...
            <div class="_scroll-sidebar" style="overflow: scroll; width: auto; height: 100%;">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="past-records" aria-expanded="false" title="Manage records in a past Term/Session"
                                data-toggle="tooltip"><i class="fa fa-file-text"></i><span class="hide-menu">Past
                                    Records</span></a>
                        </li>
                                                ...
                                                <td width="60%">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger active progress-bar-striped"
                                                            style="width: 0%; height:14px;" role="progressbar">0%
                                                        </div>
                                                    </div>
                                                </td>
                                                <td width="15%">
                                                    <a href="class-arm-data-completion.html"
