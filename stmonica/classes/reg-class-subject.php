                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="classes/register-class-subject-process" id="register-subj" method="post" accept-charset="utf-8">

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-rounded waves-effect waves-light m-t-10">Register
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="switch">
                                                            <label>
                                                                <input name="data_id[]" type="checkbox" value="9c7214d22bc63f481" class="chk">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="switch">
                                                            <label>
                                                                <input name="data_id[]" type="checkbox" value="4f36e95e1634e22a6" class="chk">
                                                                <span class="lever switch-col-light-blue"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="switch">
                                                            <label>
                                                                <input name="data_id[]" type="checkbox" value="428506663c4e8c60e" class="chk">
                                                                <span class="lever switch-col-light-blue"></span>
                                                            </label>
                                                        </div>
                                                    </td>
